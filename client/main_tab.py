...
class TableListItem(QWidget):
    def __init__(self, parent, name, address):
        ...
        self.__connect.setIcon(QIcon('assets/connect.png'))
        ...
        self.__delete.setIcon(QIcon('assets/trash.png'))
...
class FileHeader(QWidget):
    def __init__(self, parent, file_name):
        ...
        self.__file_explorer_button.setIcon(QIcon('assets/csv.png'))
...
class MainTab(QWidget):
    def __init__(self, window, file_name):
        ...
        self.__addbutton.setIcon(QIcon('assets/add.png'))
