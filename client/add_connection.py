...
class NewConnectionTab(QWidget):
    def __init__(self, parent):
        ...
        QPushButton{border-radius:2px;background:white;font-size:12px;font-family:arial;color:rgb(32,34,37);padding:5px;margin:1px;margin-top:0px;padding-left:10px;padding-right:10px;}
