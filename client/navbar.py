...
class NavBar(QScrollArea):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.sidebar.setToolTip('Toggle sidebar')
        self.sidebar.setFocusPolicy(QtCore.Qt.NoFocus)
        self.sidebar.setFixedWidth(70)
        self.sidebar.setFixedHeight(60)
        self.sidebar.setText('SIDEBAR')
        self.sidebar.clicked.connect(self.__parent.toggle_connection_list)

        layout.addWidget(self.home, 0, 0, alignment=Qt.Qt.AlignTop)
        layout.addWidget(self.connectbutton, 1, 0, alignment=Qt.Qt.AlignTop)
        layout.addWidget(self.sidebar, 2, 0, alignment=Qt.Qt.AlignTop)
