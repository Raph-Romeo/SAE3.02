...
class ServerTab(QWidget):
    def __init__(self, connection, parent, servername):
        ...
        *{background:rgb(54,57,63);color:white;padding:0;margin:0}
        ...
        self.__ramgraphbutton.setIcon(QIcon('assets/img/graph.png'))
        ...
        self.__cpugraphbutton.setIcon(QIcon('assets/img/graph.png'))
        ...
        self.__exitbutton.setIcon(QIcon('assets/img/close_bright.png'))
