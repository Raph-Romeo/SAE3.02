...
class connection_table_item(QWidget):
    def __init__(self, parent, name, addr):
        ...
        self.__addr = addr
        self.__image = QLabel()
        self.__image.setPixmap(QPixmap('assets/img/connection.png'))
...
class connections_title(QWidget):
    def __init__(self, parent):
        ...
        self.__add_button.setIcon(QIcon('assets/img/add.png'))
...
class ConnectionList(QWidget):
    def __init__(self, parent):
        ...
        self.__close_all.setIcon(QIcon('assets/img/close.png'))
